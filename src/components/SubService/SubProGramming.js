                ...
                <div className="grid grid-cols-12 relative">
                  ...
                  <div className=" col-span-12 md:col-span-6 mx-10 md:mx-16 text-left leading-8 3xl:leading-10 whitespace-pre-wrap">
                    <p className=" text-base md:text-xl 3xl:text-2xl font-normal mt-0 md:mt-12 leading-8 3xl:leading-10  whitespace-pre-wrap">
                      ทีมงานรับเขียนโปรแกรม และพัฒนาระบบตามความต้องการของท่านอย่างมืออาชีพรองรับทุกการใช้งานกับทุกธุรกิจ
                      เราพัฒนาโปรแกรม และรับทำเว็บไซต์ทุกรูปแบบ และหลากหลายเพื่อให้เหมาะกับการใช้งานของท่าน
                      ด้วยประสบการณ์ที่เรามีมามากกว่า 10 ปี
                      ทำให้ท่านมั่นใจได้ว่าท่านจะได้รับโปรแกรม และเว็บไซต์ที่มีประสิทธิภาพตรงความต้องการ
                      เหมาะสมกับธุรกิจของท่านมากที่สุด พร้อมประกันงานฟรี 1
                      ปีเต็ม
                      โดยไม่มีค่าใช้จ่าย และทีมงานของเรายังสามารถพัฒนาโปรแกรมได้หลากหลายรูปแบบ
                    </p>
                  </div>
                </div>
              </div>
