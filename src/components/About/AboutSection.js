                  ...
                  <div className="grid grid-cols-12 my-10">
                    <div className="col-span-7">
                      <blockquote className="mr-10 py-10">
                        ...
                        <p className="2xl:text-xl 3xl:text-2xl font-light 2xl:leading-normal 3xl:leading-relaxed">
                          ...
                          ตั้งแต่นั้นมา
                          ทีมงานของเราก็เติบโตอย่างรวดเร็ว และกลายเป็นหนึ่งในดิจิทัลเอเจนซี่ชั้นนำของประเทศไทย
                          แม้ว่าเราจะประสบความสำเร็จในช่วงเวลาสั้นๆ
                          แต่เรายังคงเรียนรู้ และพัฒนาทักษะ
              ...
              <div className="col-span-12 my-8">
                ...
                <blockquote>
                  ...
                  <p className="text-2xl font-semibold mx-10 my-2 text-center">
                    ...
                    ถูกสร้างขึ้นมาจากกลุ่มคนที่มีความทะเยอทะยาน และหลงใหล
                    ในสื่อดิจิทัล.
                  </p>
