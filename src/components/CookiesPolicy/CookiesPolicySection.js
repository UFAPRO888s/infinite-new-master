                    ...
                    <div className="col-span-12 mx-10 my-8">
                      <blockquote className="p-10">
                        ...
                        <p className="indent-8 text-xl 2xl:text-xl 3xl:text-2xl font-light 2xl:leading-normal 3xl:leading-relaxed mb-5">
                          ...
                          รวมถึงเพื่อความสะดวกในการเข้าถึง และใช้บริการเว็บไซต์ของท่าน
                          ...
                          ด้วยจุดประสงค์ที่จำกัดเท่าที่จำเป็น
                           และรับประกันมาตรการรักษาความมั่นคงปลอดภัยที่เหมาะสมอย่างดีที่สุดโดยสอดคล้องกับเงื่อนไข และมาตร
                        ...
                        <p className="indent-8 text-xl 2xl:text-xl 3xl:text-2xl font-light 2xl:leading-normal 3xl:leading-relaxed mb-5">
                          ...
                          ท่านตกลง และรับทราบนโยบายข้อมูลส่วนบุคคลฉบับนี้แล้ว
                          ทั้งนี้
                          ...
                          โดยผู้ใช้บริการต้องศึกษาเกี่ยวกับนโยบายข้อมูลส่วนบุคคลที่บังคับใช้ และประกาศโดยบุคคลภายนอกดังกล่าวแยกต่างหาก
                        </p>
                      ...
                      <blockquote className="p-10">
                        ...
                        <p className="indent-8 text-xl 2xl:text-xl 3xl:text-2xl font-light 2xl:leading-normal 3xl:leading-relaxed mb-5">
                          ...
                          ประเภทที่มีความจำเป็นอย่างมากต่อการทำงานของเว็บไซต์ และการให้บริการแก่ผู้ใช้งานในการเข้าถึงข้อมูลได้อย่างทั่วถึง และปลอดภัย
                        </p>
                        <p className="indent-8 text-xl 2xl:text-xl 3xl:text-2xl font-light 2xl:leading-normal 3xl:leading-relaxed mb-5">
                        ...
                        <p className="indent-8 text-xl 2xl:text-xl 3xl:text-2xl font-light 2xl:leading-normal 3xl:leading-relaxed mb-5">
                          ...
                          เพื่อนำเสนอสินค้าหรือบริการที่เกี่ยวข้อง และตรงกับความสนใจของผู้ใช้บริการ
                          ทั้งนี้
                        ...
                        <p className="indent-8 text-xl 2xl:text-xl 3xl:text-2xl font-light 2xl:leading-normal 3xl:leading-relaxed mb-5">
                          ...
                          จะมีประโยชน์ในการเสริมประสิทธิภาพในการให้บริการ และการทำงานของเว็บไซต์แก่ท่านผู้ใช้บริการ
                          แต่หากผู้ใช้บริการต้องการ ท่านสามารถลบการตั้งค่า
                          Cookies บน Browser ของตนเองได้ อย่างไรก็ตาม
                          ผู้ใช้บริการต้องรับทราบ และยอมรับว่า
                      ...
                      <blockquote className="p-10">
                        ...
                        <p className="indent-8 text-xl 2xl:text-xl 3xl:text-2xl font-light 2xl:leading-normal 3xl:leading-relaxed mb-5">
                          บริษัทรับทราบ และเคารพสิทธิในฐานะเจ้าของข้อมูลตามกฎหมายของผู้ใช้บริการในส่วนที่เกี่ยวข้องกับข้อมูลส่วนบุคคลของท่าน
                ...
                <div className="absolute top-0 left-0">
                  <blockquote className="px-10 py-5">
                    ...
                    <p className="indent-8 text-sm font-light leading-normal mb-5">
                      ...
                      เข้าถึงเว็บไซต์ของทางบริษัท บริษัทจะถือว่า
                      ท่านตกลง และรับทราบนโยบายข้อมูลส่วนบุคคลฉบับนี้แล้ว ทั้งนี้
                      นโยบายความเป็นส่วนตัวฉบับนี้มีผลใช้บังคับกับเว็บไซต์ของบริษัทเท่านั้น
                      ไม่มีผลใช้บังคับกับบริการหรือเว็บไซต์อื่นๆ
                      ที่อาจเชื่อมต่อกับเว็บไซต์ของบริษัทซึ่งเป็นของบุคคลภายนอก
                      โดยผู้ใช้บริการต้องศึกษาเกี่ยวกับนโยบายข้อมูลส่วนบุคคลที่บังคับใช้ และประกาศโดยบุคคลภายนอกดังกล่าวแยกต่างหาก
