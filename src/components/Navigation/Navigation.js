      ...
      <div className="grid grid-cols-12 gap-0">
        {isOpen ? (
          ...
          >
            ...
            <div className="mt-12">
              {navService.map((item, indexnavSer) => (
                <Link
                  key={indexnavSer}
                  to={item.to}
                  onClick={() => setIsOpen(!isOpen)}
        ...
        {isOpenMenu ? (
          ...
          >
            ...
            <div className="mt-12">
              {navigation.map((item, Indexnaviga) =>
                item.current ? (
                  <Link
                    key={Indexnaviga}
                    to={item.href}
                        ...
                        <div className="flex items-end">
                          {navigation.map((item, InnavServXC) =>
                            item.current ? (
                              ...
                              <div key={InnavServXC} className="border-t-0 border-t-infinite2-1 md:rounded-xl lg:rounded-2xl text-sm font-medium in-wave001 md:w-16 md:h-7 md:pt-0 lg:w-28 lg:h-10 lg:pt-2 text-center cursor-pointer">
                                <span
